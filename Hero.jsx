    ...
    <section className="hf-hero">
      ...
      <div className="hf-hero__inner">
        <div className="hf-hero__main">
          <span className="hf-eyebrow" style={{color: 'var(--hf-orange)'}}>HOBSON FILMS</span>
        ...
        <div className="hf-hero__bottom">
          <div className="hf-hero__creditcols">
            <div className="hf-hero__credit">
              <span className="hf-meta">DP</span>
              <span className="hf-hero__credit-val">Rob Hobson</span>
            </div>
            <div className="hf-hero__credit">
              <span className="hf-meta">CAMERA</span>
              <span className="hf-hero__credit-val">ARRI Alexa Mini LF</span>
            </div>
            <div className="hf-hero__credit">
